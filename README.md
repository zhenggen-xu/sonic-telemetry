...
To install dial-in mode system telemetry server, run
    ...
    go get -u github.com/zhenggen-xu/sonic-telemetry/telemetry

To install dial-out mode system telemetry client, run

    go get -u github.com/zhenggen-xu/sonic-telemetry/dialout/dialout_client_cli
...
There is also a test program dialout_server_cli for collecting data from dial-out mode system telemetry client. _Note_: it is for testing purpose only.
    ...
    go get -u github.com/zhenggen-xu/sonic-telemetry/dialout/dialout_server_cli
...
You can also build a debian package and install it:
    ...
    git clone https://github.com/zhenggen-xu/sonic-telemetry.git
...
See the [contributors guide](https://github.com/zhenggen-xu/SONiC/blob/gh-pages/CONTRIBUTING.md) for information about how to contribute.
